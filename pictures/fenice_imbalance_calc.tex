\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [blue, fill=blue!60] table[x=index,y=imbalance, col sep=comma, forget plot]{pictures/fenice_imbalance_calc.csv};
        \addplot[red]coordinates{(17,68)};
        \addplot[yellow]coordinates{(7,-100)};
